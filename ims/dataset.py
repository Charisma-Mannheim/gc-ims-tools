...
class GCIMS_DataSet:
    ...
    def __init__(self, data, name, files, samples, groups, _path):
        """
        DataSet class to coordinate many GCIMS_Spectrum instances
        as dask delayed objects with group and sample names available
        as attributes.
        Maps GCIMS_Spectrum methods to all spectra in DataSet and contains
        ...
        ----------
        data : list
            lists instances of GCIMS_Spectrum
    ...
    def __repr__(self):
        return f'GCIMS_DataSet: {self.name}, {len(self)} Spectra'
    ...
    def read_mea(cls, path, subfolders=False):
        ...
        GCIMS_DataSet
        """
        paths, name, files, samples, groups = GCIMS_DataSet._measurements(
            path, subfolders
        )
        data = [
    ...
    def read_zip(cls, path, subfolders=True):
        ...
        data = [
            delayed(GCIMS_Spectrum.read_zip)(i, subfolders) for i in paths
        ]
        return cls(data, name, files, samples, groups, path)
    ...
    def read_hdf5(cls, path):
        """
        Reads all hdf5 files generated by GCIMS_Spectrum.to_hdf5
    ...
    def mean(self):
        ...
        for i in grouped_data:
            means.append(delayed(GCIMS_Spectrum.mean)(i))
    ...
    def rip_scaling(self):
        ...
        """
        self.data = [
            delayed(GCIMS_Spectrum.rip_scaling)(i) for i in self.data
            ]
    ...
    def resample(self, n):
        ...
        """       
        self.data = [
            delayed(GCIMS_Spectrum.resample)(i, n) for i in self.data
            ]
    ...
    def cut_dt(self, start, stop):
        ...
        """
        self.data = [
            delayed(GCIMS_Spectrum.cut_dt)(i, start, stop) for i in self.data
        ]
    ...
    def cut_rt(self, start, stop):
        ...
        """
        self.data = [
            delayed(GCIMS_Spectrum.cut_rt)(i, start, stop) for i in self.data
        ]
    ...
    def tophat(self, size=15):
        ...
        """
        self.data = [
            delayed(GCIMS_Spectrum.tophat)(i, size) for i in self.data
        ]
    ...
    def sub_first_row(self):
        ...
        """
        self.data = [
            delayed(GCIMS_Spectrum.sub_first_row)(i) for i in self.data
        ]
    ...
    def export_plots(self, folder_name, file_format='jpeg', **kwargs):
        ...
        for i in sample_names:
            ...
            for j in indices:
                group = self.groups[j]
                fig = delayed(GCIMS_Spectrum.export_plot)(
    ...
    def export_images(self, folder_name, file_format='jpeg'):
        ...
        for i in sample_names:
            ...
            for j in indices:
                group = self.groups[j]
                fig = delayed(GCIMS_Spectrum.export_image)(
                    self.data[j], path=f'{folder_name}/{group}',
